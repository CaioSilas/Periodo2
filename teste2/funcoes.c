...
//Alocar Região tem complexidade de O(n)
...
//AlocarSudoku tem complexidade de O(n)
...
//DesalocarRegiao tem complexidade de O(n)
...
//DesalocarSudoku tem complexidade de O(n)
...
//TabuleiroInicializa  tem complexidade de O(n²)
...
//defineVazias  tem complexidade de O(n²)
...
//EhValido  tem complexidade de O(n³)
...
//valoresValidos  tem complexidade de O(n³)
...
//situacaoSudoku  tem complexidade de O(n²)
